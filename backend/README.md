...
## Project Structure
    ...
    ├── tidewaterexterminat_40947  # Django project configurations
...
1. Clone this repo and `cd tidewaterexterminat_40947`
...
2. Clone this repo and `cd tidewaterexterminat_40947`
